...
/**
Website: https://vapecat.xyz
Telegram: https://t.me/vapecatcoin
Twitter: https://twitter.com/vapecatcoin
**/
...
contract VapeCatCoin is ERC20, Ownable {
    ...
    constructor() ERC20("Vapecat Coin", unicode"VAPECAT") {
        ...
        maxTx = 4_200_000 * 1e18; // 1% from total supply 
        maxWallets = 4_200_000 * 1e18; // 1% from total supply
        ...
        marketerWallet = address(0xbf97180814dEf11E785111b806f7C233976022b2);
        DevsWallet = address(0xC7866b74382CeFec17cCf63A5AF600A4fe1150FD);
